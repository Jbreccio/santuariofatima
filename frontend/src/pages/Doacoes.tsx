    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative w-full h-70 md:h-[30rem] flex items-center justify-center overflow-hidden shadow-lg mb-12">
        ...
        <div className="absolute text-center px-4">
          ...
          <p className="text-gray-200 text-lg md:text-xl mt-3 drop-shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-8 shadow-lg">
              ...
              <div className="bg-white rounded-lg p-6 mb-4">
                ...
                <p className="text-2xl font-bold text-green-600 my-4 break-all">
                  60.909.843/0065-00
                </p>
	...
	{/* Onde Sua Doação Será Aplicada */}
        <section className="mb-16">
          ...
          <div className="bg-blue-50 rounded-xl p-6 text-center">
            <p className="text-lg text-gray-700 font-semibold italic"> Sua contribuição é fundamental para mantermos viva a missão do Santuário. </p>
          </div>
        </section>

        {/* 🔴 OUTRAS FORMAS DE AJUDAR — SEÇÃO COMPLETA */}
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Doações podem ser feitas durante as missas</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Transferências bancárias (veja detalhes acima)</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> PIX com CNPJ (veja detalhes acima)</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Arroz, feijão, macarrão</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Leite e produtos lácteos</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Óleo, sal e temperos</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Alimentos infantis</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Roupas limpas e em bom estado</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Sapatos e calçados</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Roupas infantis</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Cobertores e edredons</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Sabonete e shampoo</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Pasta de dente</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Papel higiênico</li>
                <li className="flex items-start gap-2 text-gray-600"><span className="text-red-600 mt-1">✓</span> Produtos de limpeza</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        {/* CTA Final */}
        <div className="bg-gradient-to-r from-blue-600 to-green-500 text-white rounded-xl p-8 text-center shadow-xl mb-20">

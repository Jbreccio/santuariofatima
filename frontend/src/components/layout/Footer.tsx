        ...
        <div className="flex flex-col items-center mb-4">
          ...
          <div className="flex gap-3 justify-center">
            <a 
              ...
              className="p-2 rounded-lg hover:opacity-80 transition-all hover:scale-110 transform duration-200 shadow flex items-center justify-center w-10 h-10"
              style={{
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-[#FF0000] p-2 rounded-lg hover:opacity-80 transition-all hover:scale-110 transform duration-200 shadow flex items-center justify-center w-10 h-10"
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-[#1877F2] p-2 rounded-lg hover:opacity-80 transition-all hover:scale-110 transform duration-200 shadow flex items-center justify-center w-10 h-10"

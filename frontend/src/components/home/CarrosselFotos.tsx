...
const CarrosselFotos = () => {
  ...
  const slides: Slide[] = [
    ...
    { id: 'entrada', image: '/images/carrosselFotos/entrada.png' },
    { id: 'fachada1', image: '/images/carrosselFotos/fachada1.png' },
    { id: 'fachada2', image: '/images/carrosselFotos/fachada2.png' },
    { id: 'bouquet', image: '/images/carrosselFotos/bouquet.png' },
    { id: 'cruz', image: '/images/carrosselFotos/cruz.png' },
    { id: 'entrada2', image: '/images/carrosselFotos/entrada2.png' },
    { id: 'fatima', image: '/images/carrosselFotos/fatima.png' },
    { id: 'flor', image: '/images/carrosselFotos/flor.png' },
    ...
    { id: 'cruz', image: '/images/carrosselFotos/cruz2.png' },
